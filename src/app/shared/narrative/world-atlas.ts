...
export function atlasLabelKey(id: NarrativeRealmId): string {
  return `world.atlas.label.${id}`;
}

export function atlasDescKey(id: NarrativeRealmId): string {
  return `world.atlas.desc.${id}`;
}
