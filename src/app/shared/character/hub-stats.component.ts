...
@Component({
  ...
  styles: [`
    :host { display: block; }
    .ht h2 { margin: 0 0 0.8rem; font: 700 1.15rem/1.2 'Orbitron', system-ui, sans-serif; }
    .ht__dl { display: grid; grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap: 0.7rem; margin: 0 0 1.2rem; }
    .ht__dl dt { font-size: 0.72rem; letter-spacing: .08em; text-transform: uppercase; color: rgba(232,236,241,.55); }
    .ht__dl dd { margin: 0.2rem 0 0; font-weight: 600; }
  `],
})
