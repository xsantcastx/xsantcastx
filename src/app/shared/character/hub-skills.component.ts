...
@Component({
  ...
  styles: [`
    :host { display: block; }
    .hs h2 { margin: 0 0 0.3rem; font: 700 1.15rem/1.2 'Orbitron', system-ui, sans-serif; }
    .hs__tag { margin: 0 0 1rem; color: rgba(232,236,241,.7); }
    ...
    .hs__card h3 { margin: 0 0 0.4rem; color: #EF4444; }
    .hs__go, .hs__later { min-height: 44px; }
    .hs__go { display: inline-flex; align-items: center; color: #EF4444; }
    .hs__later { margin: 1rem 0 0; padding: 0; list-style: none; color: rgba(232,236,241,.55); }
