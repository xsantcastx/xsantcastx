...
export class ButtonGeneratorComponent {
  ...
  buttonText = 'Click Me';
  bgColor = '#8B5CF6'; textColor = '#0a0e1a'; borderRadius = 8;
  paddingX = 24; paddingY = 12; fontSize = 16;
  borderWidth = 0; borderColor = '#8B5CF6';
  hoverBg = '#A78BFA'; hoverText = '#0a0e1a';
  shadow = '0 4px 14px rgba(139, 92, 246, 0.3)'; fontWeight = 600;
  copied = false;

  readonly presets: ButtonPreset[] = [
    { name: 'Primary', bgColor: '#8B5CF6', textColor: '#0a0e1a', borderRadius: 8, paddingX: 24, paddingY: 12, fontSize: 16, borderWidth: 0, borderColor: '#8B5CF6', hoverBg: '#A78BFA', hoverText: '#0a0e1a', shadow: '0 4px 14px rgba(139,92,246,0.3)', fontWeight: 600 },
    { name: 'Outline', bgColor: 'transparent', textColor: '#8B5CF6', borderRadius: 8, paddingX: 24, paddingY: 12, fontSize: 16, borderWidth: 2, borderColor: '#8B5CF6', hoverBg: '#8B5CF6', hoverText: '#0a0e1a', shadow: 'none', fontWeight: 600 },
    ...
    { name: 'Neon', bgColor: 'transparent', textColor: '#8B5CF6', borderRadius: 4, paddingX: 24, paddingY: 12, fontSize: 16, borderWidth: 2, borderColor: '#8B5CF6', hoverBg: 'rgba(139,92,246,0.1)', hoverText: '#8B5CF6', shadow: '0 0 20px rgba(139,92,246,0.4)', fontWeight: 700 },
    { name: 'Gradient', bgColor: 'linear-gradient(135deg, #8B5CF6, #7b61ff)', textColor: '#ffffff', borderRadius: 8, paddingX: 24, paddingY: 12, fontSize: 16, borderWidth: 0, borderColor: 'transparent', hoverBg: 'linear-gradient(135deg, #A78BFA, #6a4fff)', hoverText: '#ffffff', shadow: '0 4px 20px rgba(139,92,246,0.2)', fontWeight: 600 },
    ...
    { name: 'Brutal', bgColor: '#8B5CF6', textColor: '#000000', borderRadius: 0, paddingX: 24, paddingY: 12, fontSize: 16, borderWidth: 3, borderColor: '#000000', hoverBg: '#ffffff', hoverText: '#000000', shadow: '4px 4px 0 #000000', fontWeight: 800 },
  ];
