...
const routes: Routes = [
  ...
  { path: 'color-converter', loadComponent: () => import('./color-converter/color-converter.component').then(m => m.ColorConverterComponent), title: 'Free Color Converter — HEX RGB HSL CMYK · The Godforge', data: { description: 'Convert colors between HEX, RGB, HSL, HSB, and CMYK with harmonies and tints/shades.', keywords: 'color converter, hex to rgb, rgb to hsl, color picker, cmyk converter', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Color Converter', url: `${SITE_URL}/tools/color-converter`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'css-units', loadComponent: () => import('./css-units/css-units.component').then(m => m.CssUnitsComponent), title: 'Free CSS Units Converter — px rem em vw · The Godforge', data: { description: 'Convert between px, rem, em, %, vw, vh, pt, cm, mm, and in with spacing scale.', keywords: 'css units converter, px to rem, rem to px, em converter, viewport units', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'CSS Units Converter', url: `${SITE_URL}/tools/css-units`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'css-minifier', loadComponent: () => import('./css-minifier/css-minifier.component').then(m => m.CssMinifierComponent), title: 'Free CSS Minifier & Beautifier · The Godforge', data: { description: 'Minify or beautify CSS with syntax highlighting and compression stats.', keywords: 'css minifier, css beautifier, minify css online, css formatter, compress css', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'CSS Minifier & Beautifier', url: `${SITE_URL}/tools/css-minifier`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'ip-lookup', loadComponent: () => import('./ip-lookup/ip-lookup.component').then(m => m.IpLookupComponent), title: 'Free IP Address Lookup & Subnet Calculator · The Godforge', data: { description: 'Detect your public IP, validate IPv4/IPv6 addresses, and calculate subnets.', keywords: 'ip lookup, my ip address, subnet calculator, ipv4 ipv6 validator, cidr calculator', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'IP Address Lookup', url: `${SITE_URL}/tools/ip-lookup`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'jwt-generator', loadComponent: () => import('./jwt-generator/jwt-generator.component').then(m => m.JwtGeneratorComponent), title: 'Free JWT Generator & Builder — Sign Tokens · The Godforge', data: { description: 'Build and sign JWT tokens with custom claims and HMAC via Web Crypto.', keywords: 'jwt generator, jwt builder, create jwt token, jwt signer, hmac jwt', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'JWT Generator', url: `${SITE_URL}/tools/jwt-generator`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'slug-generator', loadComponent: () => import('./slug-generator/slug-generator.component').then(m => m.SlugGeneratorComponent), title: 'Free Slug Generator — URL-Friendly Text · The Godforge', data: { description: 'Convert text to URL-friendly slugs with transliteration and bulk mode.', keywords: 'slug generator, url slug, slugify text, url friendly, seo slug generator', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Slug Generator', url: `${SITE_URL}/tools/slug-generator`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'csv-json', loadComponent: () => import('./csv-json/csv-json.component').then(m => m.CsvJsonComponent), title: 'Free CSV to JSON Converter · The Godforge', data: { description: 'Convert between CSV and JSON with delimiter options and file upload.', keywords: 'csv to json, json to csv, csv converter, csv parser online', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'CSV to JSON Converter', url: `${SITE_URL}/tools/csv-json`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'color-blindness', loadComponent: () => import('./color-blindness/color-blindness.component').then(m => m.ColorBlindnessComponent), title: 'Free Color Blindness Simulator · The Godforge', data: { description: 'Simulate how colors appear under 7 types of color vision deficiency.', keywords: 'color blindness simulator, color blind test, protanopia, deuteranopia, tritanopia, accessibility', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Color Blindness Simulator', url: `${SITE_URL}/tools/color-blindness`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'git-reference', loadComponent: () => import('./git-reference/git-reference.component').then(m => m.GitReferenceComponent), title: 'Git Command Reference & Cheatsheet · The Godforge', data: { description: 'Searchable reference of 100+ git commands with examples.', keywords: 'git commands, git reference, git cheatsheet, git help', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Git Command Reference', url: `${SITE_URL}/tools/git-reference`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'responsive-preview', loadComponent: () => import('./responsive-preview/responsive-preview.component').then(m => m.ResponsivePreviewComponent), title: 'Free Responsive Design Preview · The Godforge', data: { description: 'Preview URLs at different screen sizes with device presets.', keywords: 'responsive preview, responsive tester, screen size preview, device preview', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Responsive Preview', url: `${SITE_URL}/tools/responsive-preview`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'pomodoro', loadComponent: () => import('./pomodoro/pomodoro.component').then(m => m.PomodoroComponent), title: 'Free Pomodoro Timer · The Godforge', data: { description: 'Focus timer with work/break cycles, audio alerts, and session history.', keywords: 'pomodoro timer, focus timer, productivity timer, work break timer', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Pomodoro Timer', url: `${SITE_URL}/tools/pomodoro`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'npm-search', loadComponent: () => import('./npm-search/npm-search.component').then(m => m.NpmSearchComponent), title: 'Free NPM Package Search · The Godforge', data: { description: 'Search npm packages, compare install commands, view package details.', keywords: 'npm search, npm package finder, npm registry search', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'NPM Package Search', url: `${SITE_URL}/tools/npm-search`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'json-minifier', loadComponent: () => import('./json-minifier/json-minifier.component').then(m => m.JsonMinifierComponent), title: 'Free JSON Minifier & Compressor · The Godforge', data: { description: 'Minify or beautify JSON with sort keys and compression stats.', keywords: 'json minifier, json compressor, minify json online, json beautifier', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'JSON Minifier', url: `${SITE_URL}/tools/json-minifier`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'ts-playground', loadComponent: () => import('./ts-playground/ts-playground.component').then(m => m.TsPlaygroundComponent), title: 'TypeScript Type Reference & Playground · The Godforge', data: { description: 'Interactive reference of TypeScript utility types with examples.', keywords: 'typescript types, utility types, typescript reference, partial record omit', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'TypeScript Type Reference', url: `${SITE_URL}/tools/ts-playground`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'design-tokens', loadComponent: () => import('./design-tokens/design-tokens.component').then(m => m.DesignTokensComponent), title: 'Free Design Token Converter · The Godforge', data: { description: 'Convert design tokens to CSS variables, SCSS, or Tailwind config.', keywords: 'design tokens, figma tokens, css variables generator, scss variables, tailwind config', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Design Token Converter', url: `${SITE_URL}/tools/design-tokens`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'color-name', loadComponent: () => import('./color-name/color-name.component').then(m => m.ColorNameComponent), title: 'Free CSS Color Name Finder — Hex to Named Color · The Godforge', data: { description: 'Find the closest CSS named color from any hex value. Searchable 150+ CSS color names with instant display.', keywords: 'css color name, color name finder, hex to color name, css colors, color reference', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Color Name Finder', url: `${SITE_URL}/tools/color-name`, description: 'Free CSS color name finder. Convert hex colors to named CSS colors from 150+ standard names.', applicationCategory: 'UtilityApplication', operatingSystem: 'Any Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Tools', item: `${SITE_URL}/tools` }, { '@type': 'ListItem', position: 2, name: 'Color Name Finder', item: `${SITE_URL}/tools/color-name` }] } } } },
  ...
  { path: 'html-minifier', loadComponent: () => import('./html-minifier/html-minifier.component').then(m => m.HtmlMinifierComponent), title: 'Free HTML Minifier & Beautifier — Minify & Format · The Godforge', data: { description: 'Minify or beautify HTML code with compression statistics. Remove comments, whitespace, and optimize file size.', keywords: 'html minifier, minify html, html compressor, beautify html, html formatter', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'HTML Minifier', url: `${SITE_URL}/tools/html-minifier`, description: 'Free HTML minifier and beautifier. Minify or format HTML with compression stats and optimization options.', applicationCategory: 'UtilityApplication', operatingSystem: 'Any Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Tools', item: `${SITE_URL}/tools` }, { '@type': 'ListItem', position: 2, name: 'HTML Minifier', item: `${SITE_URL}/tools/html-minifier` }] } } } },
  ...
  { path: 'json-diff', loadComponent: () => import('./json-diff/json-diff.component').then(m => m.JsonDiffComponent), title: 'Free JSON Diff Checker — Compare JSON Objects · The Godforge', data: { description: 'Compare two JSON objects side-by-side and identify additions, deletions, and changes with color highlighting.', keywords: 'json diff, json comparison, json differ, compare json, json diff tool', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'JSON Diff Checker', url: `${SITE_URL}/tools/json-diff`, description: 'Free JSON diff checker. Compare two JSON objects side-by-side with color-highlighted changes and statistics.', applicationCategory: 'UtilityApplication', operatingSystem: 'Any Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Tools', item: `${SITE_URL}/tools` }, { '@type': 'ListItem', position: 2, name: 'JSON Diff', item: `${SITE_URL}/tools/json-diff` }] } } } },
  ...
  { path: 'jwt-cheatsheet', loadComponent: () => import('./jwt-cheatsheet/jwt-cheatsheet.component').then(m => m.JwtCheatsheetComponent), title: 'Free JWT Claims Reference — JSON Web Token Guide · The Godforge', data: { description: 'Quick reference for JWT claims, algorithms, and structure. Searchable database of standard claims and examples.', keywords: 'jwt, json web token, jwt claims, jwt reference, jwt cheatsheet', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'JWT Cheatsheet', url: `${SITE_URL}/tools/jwt-cheatsheet`, description: 'Free JWT reference guide. Explore standard claims, algorithms, and code examples for JSON Web Tokens.', applicationCategory: 'UtilityApplication', operatingSystem: 'Any Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Tools', item: `${SITE_URL}/tools` }, { '@type': 'ListItem', position: 2, name: 'JWT Cheatsheet', item: `${SITE_URL}/tools/jwt-cheatsheet` }] } } } },
  { path: 'license-picker', loadComponent: () => import('./license-picker/license-picker.component').then(m => m.LicensePickerComponent), title: 'Free License Picker — Compare Open Source Licenses · The Godforge', data: { description: 'Compare popular open source licenses side-by-side. Choose the right MIT, Apache, GPL, or other license.', keywords: 'license picker, open source licenses, mit license, apache license, gpl license', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'License Picker', url: `${SITE_URL}/tools/license-picker`, description: 'Free open source license comparison tool. Compare MIT, Apache, GPL, and other licenses side-by-side.', applicationCategory: 'UtilityApplication', operatingSystem: 'Any Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Tools', item: `${SITE_URL}/tools` }, { '@type': 'ListItem', position: 2, name: 'License Picker', item: `${SITE_URL}/tools/license-picker` }] } } } },
  ...
  { path: 'docker-ref', loadComponent: () => import('./docker-ref/docker-ref.component').then(m => m.DockerRefComponent), title: 'Free Docker Compose Reference — Searchable Directives & YAML Templates · The Godforge', data: { description: 'Complete Docker Compose reference with 50+ searchable directives, categorized by services, networks, volumes, and configs. Includes ready-to-use YAML templates.', keywords: 'docker compose reference, docker compose cheatsheet, docker-compose.yml, docker compose directives, docker yaml templates, docker compose examples', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Docker Compose Reference', url: `${SITE_URL}/tools/docker-ref`, description: 'Complete Docker Compose reference with 50+ searchable directives and ready-to-use YAML templates.', applicationCategory: 'UtilityApplication', operatingSystem: 'Any Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, featureList: ['50+ directives', 'Category filters', 'YAML examples', 'Ready-to-use templates', 'One-click copy', 'Search & filter'], breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Tools', item: `${SITE_URL}/tools` }, { '@type': 'ListItem', position: 2, name: 'Docker Compose Reference', item: `${SITE_URL}/tools/docker-ref` }] } } } },
