...
const routes: Routes = [
  ...
  { path: 'color-converter', loadComponent: () => import('./color-converter/color-converter.component').then(m => m.ColorConverterComponent), title: 'Free Color Converter — HEX RGB HSL CMYK | xsantcastx', data: { description: 'Convert colors between HEX, RGB, HSL, HSB, and CMYK with harmonies and tints/shades.', keywords: 'color converter, hex to rgb, rgb to hsl, color picker, cmyk converter', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Color Converter', url: `${SITE_URL}/tools/color-converter`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'csv-json', loadComponent: () => import('./csv-json/csv-json.component').then(m => m.CsvJsonComponent), title: 'Free CSV to JSON Converter | xsantcastx', data: { description: 'Convert between CSV and JSON with delimiter options and file upload.', keywords: 'csv to json, json to csv, csv converter, csv parser online', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'CSV to JSON Converter', url: `${SITE_URL}/tools/csv-json`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'favicon-generator', loadComponent: () => import('./favicon-generator/favicon-generator.component').then(m => m.FaviconGeneratorComponent), title: 'Free Favicon Generator — Text, Emoji, Image | xsantcastx', data: { description: 'Generate favicons from text, emoji, or image with multiple sizes and HTML tags.', keywords: 'favicon generator, favicon maker, create favicon, ico generator, favicon from text', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Favicon Generator', url: `${SITE_URL}/tools/favicon-generator`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'html-to-md', loadComponent: () => import('./html-to-md/html-to-md.component').then(m => m.HtmlToMdComponent), title: 'Free HTML to Markdown Converter | xsantcastx', data: { description: 'Convert HTML to Markdown and back with no dependencies.', keywords: 'html to markdown, markdown to html, html converter', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'HTML to Markdown Converter', url: `${SITE_URL}/tools/html-to-md`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'data-size', loadComponent: () => import('./data-size/data-size.component').then(m => m.DataSizeComponent), title: 'Free Data Size Calculator | xsantcastx', data: { description: 'Convert between bytes, KB, MB, GB, TB with bandwidth calculator.', keywords: 'data size calculator, byte converter, mb to gb, bandwidth calculator', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Data Size Calculator', url: `${SITE_URL}/tools/data-size`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'color-shades', loadComponent: () => import('./color-shades/color-shades.component').then(m => m.ColorShadesComponent), title: 'Free Color Shades & Tints Generator | xsantcastx', data: { description: 'Generate tints, shades, tones, and harmonies from a single color.', keywords: 'color shades generator, tints and shades, color palette generator', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Color Shades Generator', url: `${SITE_URL}/tools/color-shades`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'git-reference', loadComponent: () => import('./git-reference/git-reference.component').then(m => m.GitReferenceComponent), title: 'Git Command Reference & Cheatsheet | xsantcastx', data: { description: 'Searchable reference of 100+ git commands with examples.', keywords: 'git commands, git reference, git cheatsheet, git help', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Git Command Reference', url: `${SITE_URL}/tools/git-reference`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'responsive-preview', loadComponent: () => import('./responsive-preview/responsive-preview.component').then(m => m.ResponsivePreviewComponent), title: 'Free Responsive Design Preview | xsantcastx', data: { description: 'Preview URLs at different screen sizes with device presets.', keywords: 'responsive preview, responsive tester, screen size preview, device preview', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Responsive Preview', url: `${SITE_URL}/tools/responsive-preview`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'pomodoro', loadComponent: () => import('./pomodoro/pomodoro.component').then(m => m.PomodoroComponent), title: 'Free Pomodoro Timer | xsantcastx', data: { description: 'Focus timer with work/break cycles, audio alerts, and session history.', keywords: 'pomodoro timer, focus timer, productivity timer, work break timer', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Pomodoro Timer', url: `${SITE_URL}/tools/pomodoro`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'css-filter', loadComponent: () => import('./css-filter/css-filter.component').then(m => m.CssFilterComponent), title: 'Free CSS Filter Generator | xsantcastx', data: { description: 'Visual CSS filter editor with blur, brightness, contrast and presets.', keywords: 'css filter generator, css filter effects, image filter css, blur brightness', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'CSS Filter Generator', url: `${SITE_URL}/tools/css-filter`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'npm-search', loadComponent: () => import('./npm-search/npm-search.component').then(m => m.NpmSearchComponent), title: 'Free NPM Package Search | xsantcastx', data: { description: 'Search npm packages, compare install commands, view package details.', keywords: 'npm search, npm package finder, npm registry search', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'NPM Package Search', url: `${SITE_URL}/tools/npm-search`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'json-minifier', loadComponent: () => import('./json-minifier/json-minifier.component').then(m => m.JsonMinifierComponent), title: 'Free JSON Minifier & Compressor | xsantcastx', data: { description: 'Minify or beautify JSON with sort keys and compression stats.', keywords: 'json minifier, json compressor, minify json online, json beautifier', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'JSON Minifier', url: `${SITE_URL}/tools/json-minifier`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'morse-code', loadComponent: () => import('./morse-code/morse-code.component').then(m => m.MorseCodeComponent), title: 'Free Morse Code Translator | xsantcastx', data: { description: 'Translate text to Morse code and back with audio playback.', keywords: 'morse code translator, morse encoder, morse decoder, morse audio', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Morse Code Translator', url: `${SITE_URL}/tools/morse-code`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'string-repeater', loadComponent: () => import('./string-repeater/string-repeater.component').then(m => m.StringRepeaterComponent), title: 'Free Text Repeater & Manipulator | xsantcastx', data: { description: 'Repeat, reverse, shuffle, sort, and deduplicate text lines.', keywords: 'text repeater, string repeater, text manipulator, sort lines, deduplicate', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Text Repeater', url: `${SITE_URL}/tools/string-repeater`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'mock-data', loadComponent: () => import('./mock-data/mock-data.component').then(m => m.MockDataComponent), title: 'Free Random Mock Data Generator | xsantcastx', data: { description: 'Generate random names, emails, addresses as JSON, CSV, or SQL.', keywords: 'mock data generator, random data, fake data, test data generator', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Mock Data Generator', url: `${SITE_URL}/tools/mock-data`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'apca-contrast', loadComponent: () => import('./apca-contrast/apca-contrast.component').then(m => m.ApcaContrastComponent), title: 'Free APCA Contrast Calculator | xsantcastx', data: { description: 'Calculate APCA and WCAG 2.x contrast ratios with font compliance.', keywords: 'apca contrast, wcag contrast, color contrast calculator, accessibility contrast', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'APCA Contrast Calculator', url: `${SITE_URL}/tools/apca-contrast`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'ts-playground', loadComponent: () => import('./ts-playground/ts-playground.component').then(m => m.TsPlaygroundComponent), title: 'TypeScript Type Reference & Playground | xsantcastx', data: { description: 'Interactive reference of TypeScript utility types with examples.', keywords: 'typescript types, utility types, typescript reference, partial record omit', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'TypeScript Type Reference', url: `${SITE_URL}/tools/ts-playground`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'caesar-cipher', loadComponent: () => import('./caesar-cipher/caesar-cipher.component').then(m => m.CaesarCipherComponent), title: 'Free ROT13 & Caesar Cipher | xsantcastx', data: { description: 'Encode/decode ROT13 and Caesar cipher with brute force view.', keywords: 'rot13, caesar cipher, cipher encoder, brute force cipher, rotation cipher', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'ROT13 & Caesar Cipher', url: `${SITE_URL}/tools/caesar-cipher`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  { path: 'design-tokens', loadComponent: () => import('./design-tokens/design-tokens.component').then(m => m.DesignTokensComponent), title: 'Free Design Token Converter | xsantcastx', data: { description: 'Convert design tokens to CSS variables, SCSS, or Tailwind config.', keywords: 'design tokens, figma tokens, css variables generator, scss variables, tailwind config', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Design Token Converter', url: `${SITE_URL}/tools/design-tokens`, applicationCategory: 'UtilityApplication', operatingSystem: 'Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } } },
  ...
  { path: 'license-picker', loadComponent: () => import('./license-picker/license-picker.component').then(m => m.LicensePickerComponent), title: 'Free License Picker — Compare Open Source Licenses | xsantcastx', data: { description: 'Compare popular open source licenses side-by-side. Choose the right MIT, Apache, GPL, or other license.', keywords: 'license picker, open source licenses, mit license, apache license, gpl license', ogImage: `${SITE_URL}/assets/og/og-default.jpg`, jsonLd: { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'License Picker', url: `${SITE_URL}/tools/license-picker`, description: 'Free open source license comparison tool. Compare MIT, Apache, GPL, and other licenses side-by-side.', applicationCategory: 'UtilityApplication', operatingSystem: 'Any Web Browser', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Tools', item: `${SITE_URL}/tools` }, { '@type': 'ListItem', position: 2, name: 'License Picker', item: `${SITE_URL}/tools/license-picker` }] } } } },
