...
export class WebhookTesterComponent {
  ...
  readonly templates: Record<string, string> = {
    ...
    'Slack Message': JSON.stringify({ text: 'Hello from webhook!', channel: '#general', username: 'webhookbot', icon_emoji: ':robot_face:', attachments: [{ color: '#8B5CF6', title: 'Notification', text: 'Something happened' }] }, null, 2),
  };
