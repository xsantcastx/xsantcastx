...
export const TOOLS_REGISTRY: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: 'Drop a .har capture and get a request waterfall, Core Web Vitals, findings and a privacy-redacted export.',
    route: '/tools/har-analyzer',
    status: 'live',
    category: 'DevOps',
    tags: ['Performance', 'Network', 'DevTools', 'Debugging'],
    svgIcon: `<line x1="3" y1="7" x2="11" y2="7" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="7" y1="12" x2="18" y2="12" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="5" y1="17" x2="14" y2="17" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="20" y1="3" x2="20" y2="21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-dasharray="2 3"/>`,
    textIcon: '▤',
    features: ['Interactive request waterfall', 'Core Web Vitals reconstruction', 'Privacy redaction export', 'Handles 100 MB captures'],
    featured: true,
  },
  {
    id: 'regex-builder',
    title: 'Regex Builder & Tester',
    description: 'Build, test and debug regular expressions with live match highlighting, capture groups and replace preview.',
    route: '/tools/regex-builder',
    status: 'live',
    category: 'Text & Data',
    tags: ['Regex', 'RegExp', 'Testing', 'DevTools'],
    svgIcon: `<path d="M4 17l6-10 6 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="7" y1="13" x2="13" y2="13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><circle cx="19" cy="8" r="2" stroke="currentColor" stroke-width="2" fill="none"/>`,
    textIcon: '.*',
    features: ['Live match highlighting', 'Capture & named groups', 'Find & replace preview', 'Cheatsheet + 6 flavors'],
    featured: true,
  },
  {
  ...
  { id: 'grocery-manager', title: 'Grocery Manager', description: 'Track staples you always buy, get restock reminders based on the last time you bought them, and estimate your bill by region.', route: '/tools/grocery-manager', status: 'live', category: 'Productivity', tags: ['Grocery', 'Shopping List', 'Tracker', 'Planner', 'Budget'], svgIcon: '<circle cx="9" cy="21" r="1" fill="currentColor"/><circle cx="20" cy="21" r="1" fill="currentColor"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>', textIcon: '🛒', features: ['Restock reminders', 'Bilingual EN/ES', 'Bill estimate by region', 'Saved in your browser'], featured: true },
  ...
  { id: 'ascii-art', title: 'ASCII Art Generator', description: 'Generate block letter ASCII art text from any input with multiple display styles.', route: '/tools/ascii-art', status: 'live', category: 'Text & Data', tags: ['ASCII', 'Generator', 'Text', 'Art'], svgIcon: '<rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><text x="7" y="16" font-size="10" font-weight="bold" fill="currentColor" font-family="monospace">A1</text>', textIcon: '✎', features: ['Block letter generator', 'Copy to clipboard', 'Live preview', 'Multiple styles'] },
  { id: 'button-generator', title: 'CSS Button Generator', description: 'Create styled HTML buttons with customizable colors, sizes, and hover effects.', route: '/tools/button-generator', status: 'live', category: 'CSS Tools', tags: ['CSS', 'Button', 'Generator', 'Design'], svgIcon: '<rect x="4" y="7" width="16" height="10" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M9 12h6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>', textIcon: '◘', features: ['10 button presets', 'Color picker', 'Hover effects', 'One-click copy'] },
  { id: 'checklist', title: 'Smart Checklist', description: 'Interactive to-do list with categories, persistent storage, and quick actions.', route: '/tools/checklist', status: 'live', category: 'Productivity', tags: ['Checklist', 'Todo', 'Productivity', 'Organization'], svgIcon: '<rect x="4" y="5" width="16" height="14" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><polyline points="8 11 10 13 14 9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>', textIcon: '✓', features: ['Add & manage tasks', 'Categories & sorting', 'Local storage', 'Quick delete'] },
  { id: 'color-name', title: 'CSS Color Name Finder', description: 'Find the closest named CSS color from any hex value with instant display.', route: '/tools/color-name', status: 'live', category: 'CSS Tools', tags: ['Color', 'CSS', 'Converter', 'Name'], svgIcon: '<circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="12" cy="12" r="6" fill="currentColor" opacity="0.6"/>', textIcon: '◉', features: ['Hex to color name', '150+ CSS colors', 'Live search', 'Copy name'] },
  { id: 'color-picker', title: 'Advanced Color Picker', description: 'RGB, HSL, and hex color picker with slider controls, history, and palette building.', route: '/tools/color-picker', status: 'live', category: 'CSS Tools', tags: ['Color', 'Picker', 'Design', 'Sliders'], svgIcon: '<circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="9" cy="10" r="2" fill="currentColor"/><circle cx="15" cy="10" r="2" fill="currentColor" opacity="0.6"/><circle cx="12" cy="16" r="2" fill="currentColor" opacity="0.3"/>', textIcon: '◈', features: ['RGB/HSL/HEX input', 'Interactive sliders', 'Color history', 'Export palette'] },
  { id: 'countdown', title: 'Countdown Timer', description: 'Count down to any date and time with formatted display and browser notifications.', route: '/tools/countdown', status: 'live', category: 'Productivity', tags: ['Timer', 'Countdown', 'Productivity', 'Date'], svgIcon: '<circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/><path d="M12 6v6l4 2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>', textIcon: '⏰', features: ['Any date target', 'Live countdown', 'Browser alerts', 'Formatted display'] },
  { id: 'gitignore-generator', title: 'Gitignore Generator', description: 'Generate .gitignore files for your project framework or tech stack.', route: '/tools/gitignore-generator', status: 'live', category: 'Productivity', tags: ['Git', 'Generator', 'DevTools', 'Framework'], svgIcon: '<path d="M4 4h16v16H4z" stroke="currentColor" stroke-width="2" fill="none" rx="2"/><path d="M4 10h16M10 4v16" stroke="currentColor" stroke-width="1" opacity="0.3"/><text x="6" y="13" font-size="6" fill="currentColor" font-weight="bold">.git</text>', textIcon: '⚙', features: ['20+ frameworks', 'Searchable', 'Combine multiple', 'One-click copy'] },
  { id: 'heading-checker', title: 'HTML Heading Checker', description: 'Analyze heading hierarchy and structure to find accessibility and SEO issues.', route: '/tools/heading-checker', status: 'live', category: 'SEO Tools', tags: ['HTML', 'Accessibility', 'SEO', 'Validation'], svgIcon: '<rect x="3" y="4" width="18" height="3" rx="1" stroke="currentColor" stroke-width="1.5" fill="none"/><rect x="5" y="10" width="14" height="2" rx="1" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.6"/><rect x="7" y="15" width="10" height="2" rx="1" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.3"/>', textIcon: 'H1', features: ['Validate structure', 'Detect duplicates', 'Accessibility check', 'Report generation'] },
  { id: 'hmac-generator', title: 'HMAC Generator', description: 'Generate HMAC signatures with SHA algorithms for secure message authentication.', route: '/tools/hmac-generator', status: 'live', category: 'Security Tools', tags: ['HMAC', 'Security', 'Hash', 'Crypto'], svgIcon: '<rect x="4" y="6" width="16" height="12" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.5" fill="none"/>', textIcon: '🔐', features: ['SHA1/256/512', 'Multiple formats', 'Copy to clipboard', 'Live preview'] },
  { id: 'html-minifier', title: 'HTML Minifier & Beautifier', description: 'Minify or beautify HTML code with compression statistics and optimization.', route: '/tools/html-minifier', status: 'live', category: 'Code Converters', tags: ['HTML', 'Minifier', 'Code', 'Optimization'], svgIcon: '<path d="M4 4h16v16H4z" stroke="currentColor" stroke-width="2" fill="none" rx="2"/><path d="M7 8h4M7 12h10M7 16h3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.6"/>', textIcon: '◇', features: ['Minify & beautify', 'Compression stats', 'Remove comments', 'Format control'] },
  { id: 'js-minifier', title: 'JavaScript Minifier & Beautifier', description: 'Minify or format JavaScript code with compression analysis and validation.', route: '/tools/js-minifier', status: 'live', category: 'Code Converters', tags: ['JavaScript', 'Minifier', 'Code', 'Optimization'], svgIcon: '<path d="M4 4h16v16H4z" stroke="currentColor" stroke-width="2" fill="none" rx="2"/><text x="6" y="16" font-size="10" font-weight="bold" fill="currentColor" font-family="monospace">js</text>', textIcon: '◈', features: ['Minify code', 'Format & beautify', 'Compression %', 'Syntax check'] },
  { id: 'json-diff', title: 'JSON Diff Checker', description: 'Compare two JSON objects side-by-side and identify additions, deletions, and changes.', route: '/tools/json-diff', status: 'live', category: 'Code Converters', tags: ['JSON', 'Diff', 'Comparison', 'DevTools'], svgIcon: '<rect x="4" y="4" width="8" height="16" rx="1" stroke="currentColor" stroke-width="2" fill="none"/><rect x="12" y="4" width="8" height="16" rx="1" stroke="currentColor" stroke-width="2" fill="none"/><line x1="6" y1="12" x2="18" y2="12" stroke="currentColor" stroke-width="1" opacity="0.3"/>', textIcon: '≠', features: ['Side-by-side diff', 'Color highlighting', 'Statistics', 'Deep comparison'] },
  { id: 'json-tree', title: 'JSON Tree Explorer', description: 'Explore JSON data as an interactive tree and get property paths in dot or bracket notation.', route: '/tools/json-tree', status: 'live', category: 'Code Converters', tags: ['JSON', 'Path', 'Explorer', 'DevTools'], svgIcon: '<circle cx="12" cy="5" r="3" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="5" cy="18" r="3" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="19" cy="18" r="3" stroke="currentColor" stroke-width="2" fill="none"/><path d="M12 8v4M8 15l-1.5 1M16 15l1.5 1" stroke="currentColor" stroke-width="2"/>', textIcon: '🌳', features: ['Interactive tree', 'Dot & bracket paths', 'Search & filter', 'Copy path'] },
  { id: 'jwt-cheatsheet', title: 'JWT Claims Reference', description: 'Quick reference for JSON Web Token claims, algorithms, and structure.', route: '/tools/jwt-cheatsheet', status: 'live', category: 'Security Tools', tags: ['JWT', 'Reference', 'Security', 'Auth'], svgIcon: '<rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M3 9h18M3 15h18" stroke="currentColor" stroke-width="1" opacity="0.3"/><text x="6" y="13" font-size="7" fill="currentColor" font-weight="bold">JWT</text>', textIcon: '🔑', features: ['Standard claims', 'Algorithm list', 'Code examples', 'Searchable'] },
  { id: 'license-picker', title: 'License Picker', description: 'Compare and choose the right open source license for your project.', route: '/tools/license-picker', status: 'live', category: 'Productivity', tags: ['License', 'Open Source', 'Legal'], svgIcon: '<rect x="4" y="5" width="16" height="14" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M8 10h8M8 13h6M8 16h8" stroke="currentColor" stroke-width="1.5" opacity="0.5"/>', textIcon: '📜', features: ['10+ popular licenses', 'Side-by-side compare', 'License details', 'Copy text'] },
  { id: 'line-sorter', title: 'Line Sorter', description: 'Sort text lines alphabetically, by length, numerically, or randomly.', route: '/tools/line-sorter', status: 'live', category: 'Text & Data', tags: ['Text', 'Sort', 'Utility', 'Lines'], svgIcon: '<path d="M5 7h2M7 7v10M9 7h2M5 13h2M9 13h2M5 19h2M9 19h2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><polyline points="15 10 19 14 15 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/>', textIcon: '↕', features: ['Multiple sort modes', 'Remove duplicates', 'Randomize', 'One-click copy'] },
  { id: 'mime-lookup', title: 'MIME Type Lookup', description: 'Searchable reference for file extensions and corresponding MIME types.', route: '/tools/mime-lookup', status: 'live', category: 'Productivity', tags: ['MIME', 'Reference', 'DevTools', 'File Types'], svgIcon: '<rect x="3" y="4" width="18" height="16" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M9 4v16M12 7v12" stroke="currentColor" stroke-width="1" opacity="0.3"/>', textIcon: '📁', features: ['500+ MIME types', 'Search by extension', 'Copy MIME type', 'File categories'] },
  { id: 'og-image-preview', title: 'OG Image Preview', description: 'Preview how your Open Graph tags display on Facebook, Twitter, LinkedIn, and Discord.', route: '/tools/og-image-preview', status: 'live', category: 'SEO Tools', tags: ['OG', 'Social', 'Preview', 'SEO', 'Meta'], svgIcon: '<rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><rect x="5" y="7" width="14" height="5" fill="currentColor" opacity="0.3"/><path d="M5 14h14" stroke="currentColor" stroke-width="1.5"/><path d="M5 17h8" stroke="currentColor" stroke-width="1" opacity="0.4"/>', textIcon: '📱', features: ['Social platform preview', 'All major platforms', 'Live editor', 'Validation'] },
  { id: 'package-json', title: 'Package.json Builder', description: 'Visual editor for package.json with script presets and dependency management.', route: '/tools/package-json', status: 'live', category: 'Productivity', tags: ['Package.json', 'NPM', 'DevTools'], svgIcon: '<rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="8" cy="8" r="2" fill="currentColor"/><circle cx="16" cy="8" r="2" fill="currentColor" opacity="0.5"/><circle cx="8" cy="16" r="2" fill="currentColor" opacity="0.3"/><circle cx="16" cy="16" r="2" fill="currentColor" opacity="0.7"/>', textIcon: '📦', features: ['Visual JSON editor', 'Script presets', 'Dependency manager', 'One-click copy'] },
  { id: 'regex-cheatsheet', title: 'Regex Cheatsheet', description: '80+ regex patterns categorized and searchable for common use cases.', route: '/tools/regex-cheatsheet', status: 'live', category: 'Code Converters', tags: ['Regex', 'Reference', 'DevTools', 'Pattern'], svgIcon: '<path d="M4 4h16v16H4z" stroke="currentColor" stroke-width="2" fill="none" rx="2"/><path d="M7 10l2 2 4-4M7 16l2 2 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>', textIcon: '.*', features: ['80+ patterns', 'Categorized', 'Copy regex', 'Searchable'] },
  { id: 'scroll-snap', title: 'CSS Scroll-Snap Builder', description: 'Create scroll-snap layouts with visual controls and live preview.', route: '/tools/scroll-snap', status: 'live', category: 'CSS Tools', tags: ['CSS', 'Scroll', 'Generator', 'Layout'], svgIcon: '<rect x="4" y="4" width="16" height="16" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><rect x="6" y="6" width="12" height="5" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.6"/><rect x="6" y="13" width="12" height="5" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.3"/>', textIcon: '◤', features: ['Visual builder', 'Direction control', 'Snap alignment', 'Code export'] },
  { id: 'spacing-scale', title: 'Spacing Scale Generator', description: 'Generate linear and geometric spacing scales for consistent design systems.', route: '/tools/spacing-scale', status: 'live', category: 'CSS Tools', tags: ['Spacing', 'Scale', 'Design', 'System'], svgIcon: '<rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><rect x="5" y="5" width="2" height="2" fill="currentColor"/><rect x="9" y="6" width="3" height="3" fill="currentColor" opacity="0.6"/><rect x="14" y="7" width="4" height="4" fill="currentColor" opacity="0.3"/>', textIcon: '▢', features: ['Linear & geometric', 'Custom ratio', 'CSS export', 'Copy values'] },
  { id: 'timezone-converter', title: 'Timezone Converter', description: 'Convert times between 30+ timezones with automatic DST handling.', route: '/tools/timezone-converter', status: 'live', category: 'Productivity', tags: ['Timezone', 'Converter', 'Time', 'Utility'], svgIcon: '<circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/><path d="M12 2v20M2 12h20" stroke="currentColor" stroke-width="1" opacity="0.3"/><path d="M12 4v8l-6 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>', textIcon: '🌍', features: ['30+ timezones', 'Auto DST handling', 'Current time', 'Easy comparison'] },
  { id: 'transform-playground', title: 'CSS Transform Playground', description: 'Translate, rotate, scale, and skew elements with live 3D preview.', route: '/tools/transform-playground', status: 'live', category: 'CSS Tools', tags: ['CSS', 'Transform', 'Generator', '3D'], svgIcon: '<rect x="5" y="7" width="10" height="8" stroke="currentColor" stroke-width="2" fill="none" transform="translate(2 2) rotate(15)"/><path d="M12 4v4M16 8h-4M14 6l-2 2" stroke="currentColor" stroke-width="1" opacity="0.4"/>', textIcon: '⟲', features: ['3D preview', 'All transforms', 'Live sliders', 'Code export'] },
  { id: 'transition-generator', title: 'CSS Transition Generator', description: 'Build CSS transitions with cubic-bezier curve editor and live previews.', route: '/tools/transition-generator', status: 'live', category: 'CSS Tools', tags: ['CSS', 'Transition', 'Generator', 'Animation'], svgIcon: '<path d="M3 12c0 0 3-3 4.5-3S10 12 12 12s3.5-3 5-3S21 12 21 12" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/><circle cx="3" cy="12" r="1.5" fill="currentColor"/><circle cx="21" cy="12" r="1.5" fill="currentColor"/>', textIcon: '↝', features: ['Cubic-bezier editor', 'Easing presets', 'Live preview', 'Code copy'] },
  { id: 'ua-parser', title: 'User Agent Parser', description: 'Parse and analyze browser and device information from user agent strings.', route: '/tools/ua-parser', status: 'live', category: 'Productivity', tags: ['User Agent', 'Parser', 'DevTools', 'Browser'], svgIcon: '<rect x="3" y="6" width="18" height="12" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M3 9h18M8 12h8" stroke="currentColor" stroke-width="1" opacity="0.4"/>', textIcon: '🔍', features: ['Parse UA strings', 'Browser detection', 'Device info', 'Copy parsed data'] },
  { id: 'webhook-tester', title: 'Webhook Tester', description: 'Test webhooks with payload builder, templates, and request inspection.', route: '/tools/webhook-tester', status: 'live', category: 'Productivity', tags: ['Webhook', 'Testing', 'DevTools', 'API'], svgIcon: '<rect x="4" y="5" width="16" height="14" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M8 9l2 2 4-4M8 15l2 2 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>', textIcon: '🪝', features: ['Payload builder', 'Request templates', 'History', 'Copy payload'] },
  { id: 'gradient-text', title: 'CSS Gradient Text Generator', description: 'Create gradient text effects with CSS. Pick colors, adjust direction, copy code.', route: '/tools/gradient-text', status: 'live', category: 'CSS Tools', tags: ['CSS', 'Gradient', 'Text', 'Generator'], svgIcon: '<text x="3" y="18" font-size="16" font-weight="bold" fill="none" stroke="currentColor" stroke-width="1.5">Aa</text>', textIcon: '🌈', features: ['Multi-stop gradients', 'Direction control', 'Live preview', 'One-click CSS copy'] },
  { id: 'hex-editor', title: 'Hex Editor', description: 'View and edit binary data in hexadecimal with file loading and byte inspection.', route: '/tools/hex-editor', status: 'live', category: 'Productivity', tags: ['Hex', 'Binary', 'Editor', 'Data'], svgIcon: '<rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><text x="5" y="14" font-size="8" fill="currentColor" font-family="monospace">0xF</text>', textIcon: '⬡', features: ['Hex + ASCII view', 'File loading', 'Byte editing', 'Search patterns'] },
  { id: 'sitemap-generator', title: 'XML Sitemap Generator', description: 'Generate XML sitemaps with priority and change frequency for SEO.', route: '/tools/sitemap-generator', status: 'live', category: 'SEO Tools', tags: ['Sitemap', 'XML', 'SEO', 'Generator'], svgIcon: '<rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M7 8h10M7 12h7M7 16h10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.7"/>', textIcon: '🗺', features: ['Add URLs manually', 'Set priority & frequency', 'Download XML', 'Validate structure'] },
  { id: 'seo-checker', title: 'SEO Checker', description: 'Analyze page titles, meta descriptions, and keywords with a live SERP preview.', route: '/tools/seo-checker', status: 'live', category: 'SEO Tools', tags: ['SEO', 'SERP', 'Title', 'Meta', 'Keywords'], svgIcon: '<circle cx="11" cy="11" r="8" stroke="currentColor" stroke-width="2" fill="none"/><line x1="21" y1="21" x2="16.65" y2="16.65" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M8 11h6M11 8v6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.5"/>', textIcon: '🔍', features: ['Title length analysis', 'Meta description checker', 'Live SERP preview', 'Keyword density', 'Open Graph preview', 'SEO suggestions'] },
  { id: 'encoding-converter', title: 'Encoding Converter', description: 'Convert text between UTF-8, ASCII, URL encoding, HTML entities, Unicode escapes, and more.', route: '/tools/encoding-converter', status: 'live', category: 'Text & Data', tags: ['Encoding', 'UTF-8', 'ASCII', 'URL', 'HTML', 'Unicode'], svgIcon: '<path d="M4 7h6M4 12h8M4 17h5" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M14 7l3 5-3 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M20 7l-3 5 3 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none" opacity="0.5"/>', textIcon: '🔄', features: ['9 encoding formats', 'Hex dump view', 'Character breakdown table', 'Byte count stats', 'One-click copy'] },
  { id: 'crontab-ref', title: 'Crontab Quick Reference', description: 'Visual cron syntax guide with 30+ categorized expressions, search, copy, and next run calculator.', route: '/tools/crontab-ref', status: 'live', category: 'DevOps', tags: ['Cron', 'Crontab', 'Scheduling', 'DevOps', 'Reference'], svgIcon: '<circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="2" fill="none"/><polyline points="12 7 12 12 15 14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M12 3v1M12 20v1M3 12h1M20 12h1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.4"/>', textIcon: '⏰', features: ['30+ cron expressions', 'Category filters', 'Next run calculator', 'Syntax diagram', 'Wildcard reference', 'One-click copy'] },
  { id: 'css-variables', title: 'CSS Custom Properties Generator', description: 'Build a design system with CSS custom properties. Add, import, preview, and export to CSS/SCSS/JSON/Tailwind.', route: '/tools/css-variables', status: 'live', category: 'CSS', tags: ['CSS', 'Variables', 'Design Tokens', 'SCSS', 'Tailwind', 'Design System'], svgIcon: '<path d="M12 2L2 7l10 5 10-5-10-5z" stroke="currentColor" stroke-width="2" stroke-linejoin="round" fill="none"/><path d="M2 17l10 5 10-5" stroke="currentColor" stroke-width="2" stroke-linejoin="round" fill="none"/><path d="M2 12l10 5 10-5" stroke="currentColor" stroke-width="2" stroke-linejoin="round" fill="none"/>', textIcon: '🎨', features: ['Add/edit/delete variables', 'Import from CSS', 'Live preview', 'Export CSS/SCSS/JSON/Tailwind', 'Color swatches', 'Sample variables'] },
  { id: 'docker-ref', title: 'Docker Compose Reference', description: 'Complete Docker Compose reference with 50+ searchable directives and ready-to-use YAML templates.', route: '/tools/docker-ref', status: 'live', category: 'DevOps', tags: ['Docker', 'Docker Compose', 'YAML', 'DevOps', 'Reference', 'Containers'], svgIcon: '<path d="M22 12c-1.5 4.5-5 7-10 7s-8-2-10-5" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/><rect x="4" y="6" width="4" height="3" rx="0.5" stroke="currentColor" stroke-width="1.5" fill="none"/><rect x="10" y="6" width="4" height="3" rx="0.5" stroke="currentColor" stroke-width="1.5" fill="none"/><rect x="10" y="2" width="4" height="3" rx="0.5" stroke="currentColor" stroke-width="1.5" fill="none"/><rect x="16" y="6" width="4" height="3" rx="0.5" stroke="currentColor" stroke-width="1.5" fill="none"/>', textIcon: '🐳', features: ['50+ directives', 'Category filters', 'YAML examples', 'Ready-to-use templates', 'One-click copy', 'Search & filter'] },
  { id: 'media-query', title: 'CSS Media Query Builder', description: 'Visual media query generator with Bootstrap, Tailwind presets, live breakpoint detection, and one-click copy.', route: '/tools/media-query', status: 'live', category: 'CSS Tools', tags: ['CSS', 'Media Query', 'Responsive', 'Breakpoints', 'Bootstrap', 'Tailwind'], svgIcon: '<rect x="2" y="3" width="20" height="14" rx="2" stroke="currentColor" stroke-width="2" fill="none"/><path d="M8 21h8M12 17v4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M7 8h4M7 11h3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity="0.6"/>', textIcon: '📱', features: ['Visual query builder', 'Bootstrap presets', 'Tailwind presets', 'Live breakpoint detection', 'AND/OR combinator', 'One-click copy'] },
  { id: 'progress-bar', title: 'CSS Progress Bar Generator', description: 'Design custom CSS progress bars with animated stripes, gradient fills, presets, and live preview.', route: '/tools/progress-bar', status: 'live', category: 'CSS Generators', tags: ['CSS', 'Progress Bar', 'Animation', 'Generator', 'UI'], svgIcon: '<rect x="2" y="8" width="20" height="8" rx="4" stroke="currentColor" stroke-width="2" fill="none"/><rect x="3" y="9" width="12" height="6" rx="3" fill="currentColor" opacity="0.3"/><rect x="3" y="9" width="8" height="6" rx="3" fill="currentColor" opacity="0.6"/>', textIcon: '📊', features: ['Live preview', 'Animated stripes', 'Gradient fills', '6 presets', 'HTML + CSS output', 'Label options'] },
  { id: 'clip-path', title: 'CSS Clip-Path Generator', description: 'Visually design CSS clip-path shapes with drag handles, presets, and one-click code copy.', route: '/tools/clip-path', status: 'live', category: 'CSS Tools', tags: ['CSS', 'Clip-Path', 'Shapes', 'Polygon', 'Generator'], svgIcon: '<polygon points="12,2 22,8.5 22,15.5 12,22 2,15.5 2,8.5" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.5"/>', textIcon: '✂️', features: ['Visual editor', 'Drag handles', '10+ presets', 'Polygon, circle, ellipse, inset', 'Live preview', 'One-click copy'] },
  { id: 'char-map', title: 'Special Characters & Symbols Map', description: 'Browse 400+ Unicode characters across 8 categories. Click any glyph to copy as character, HTML entity, or Unicode codepoint.', route: '/tools/char-map', status: 'live', category: 'Reference', tags: ['Unicode', 'Symbols', 'Characters', 'HTML Entities', 'Reference'], svgIcon: '<path d="M5 5h14v14H5z" stroke="currentColor" stroke-width="2" fill="none"/><path d="M9 9h2M13 9h2M9 13h2M13 13h2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>', textIcon: 'Ω', features: ['400+ Unicode chars', '8 categories', 'Search by name/keyword/codepoint', 'Copy as char/HTML/Unicode', 'Recent characters', 'Client-side only'] },
  { id: 'svg-path-editor', title: 'SVG Path Visualizer & Editor', description: 'Paste, visualize, edit, and minify SVG path data with draggable control points and live measurements.', route: '/tools/svg-path-editor', status: 'live', category: 'SVG Tools', tags: ['SVG', 'Path', 'Bezier', 'Editor', 'Minifier', 'Visualizer'], svgIcon: '<path d="M3 18 C 6 6, 12 6, 12 12 S 18 18, 21 6" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/><circle cx="3" cy="18" r="1.5" fill="currentColor"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/><circle cx="21" cy="6" r="1.5" fill="currentColor"/>', textIcon: '✒️', features: ['Path parser', 'Draggable control points', 'Pan & zoom viewport', 'Bounding box & length', 'Minified output with precision control', 'Preset shapes', 'Inline command editor'] },
];
