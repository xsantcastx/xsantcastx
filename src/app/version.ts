...
export const VERSION_HISTORY: VersionRelease[] = [
  {
    ...
    date: '2026-08-12',
    highlights: [
      'Progress follows you between devices. Sign in with Google from the progression panel and the whole Godforge — XP, rank, Aether and Nox, the streak, every achievement, the Gold and Essence ledger, upgrades, artifacts, cosmetics, quest history, lore chapters and tool mastery — is kept in step across every browser you use',
