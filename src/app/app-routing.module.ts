...
const routes: Routes = [
  ...
  { path: 'embed/gradient-text', component: GradientTextComponent, data: { embed: true } },
  { path: 'embed/hex-editor', component: HexEditorComponent, data: { embed: true } },
  { path: 'embed/sitemap-generator', component: SitemapGeneratorComponent, data: { embed: true } },
  { path: 'embed/seo-checker', component: SeoCheckerComponent, data: { embed: true } },
  { path: 'embed/encoding-converter', component: EncodingConverterComponent, data: { embed: true } },
  ...
  // ── Embed routes for tools added after initial embed batch (unblocks SSR prerender; 27 slugs from sitemap-added tools) ──
  { path: 'embed/ascii-art', component: AsciiArtComponent, data: { embed: true } },
  { path: 'embed/button-generator', component: ButtonGeneratorComponent, data: { embed: true } },
  { path: 'embed/checklist', component: ChecklistComponent, data: { embed: true } },
  { path: 'embed/color-name', component: ColorNameComponent, data: { embed: true } },
  { path: 'embed/color-picker', component: ColorPickerComponent, data: { embed: true } },
  { path: 'embed/countdown', component: CountdownComponent, data: { embed: true } },
  { path: 'embed/gitignore-generator', component: GitignoreGeneratorComponent, data: { embed: true } },
  { path: 'embed/heading-checker', component: HeadingCheckerComponent, data: { embed: true } },
  { path: 'embed/hmac-generator', component: HmacGeneratorComponent, data: { embed: true } },
  { path: 'embed/html-minifier', component: HtmlMinifierComponent, data: { embed: true } },
  { path: 'embed/js-minifier', component: JsMinifierComponent, data: { embed: true } },
  { path: 'embed/json-diff', component: JsonDiffComponent, data: { embed: true } },
  { path: 'embed/json-tree', component: JsonTreeComponent, data: { embed: true } },
  { path: 'embed/jwt-cheatsheet', component: JwtCheatsheetComponent, data: { embed: true } },
  { path: 'embed/license-picker', component: LicensePickerComponent, data: { embed: true } },
  { path: 'embed/line-sorter', component: LinesorterComponent, data: { embed: true } },
  { path: 'embed/mime-lookup', component: MimeLookupComponent, data: { embed: true } },
  { path: 'embed/og-image-preview', component: OgImagePreviewComponent, data: { embed: true } },
  { path: 'embed/package-json', component: PackageJsonComponent, data: { embed: true } },
  { path: 'embed/regex-cheatsheet', component: RegexCheatsheetComponent, data: { embed: true } },
  { path: 'embed/scroll-snap', component: ScrollSnapComponent, data: { embed: true } },
  { path: 'embed/spacing-scale', component: SpacingScaleComponent, data: { embed: true } },
  { path: 'embed/timezone-converter', component: TimezoneConverterComponent, data: { embed: true } },
  { path: 'embed/transform-playground', component: TransformPlaygroundComponent, data: { embed: true } },
  { path: 'embed/transition-generator', component: TransitionGeneratorComponent, data: { embed: true } },
  { path: 'embed/ua-parser', component: UaParserComponent, data: { embed: true } },
  { path: 'embed/webhook-tester', component: WebhookTesterComponent, data: { embed: true } },
