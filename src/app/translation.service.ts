...
export class TranslationService {
  ...
  private translations: Translations = {
    ...
    'forge.recipe.sub':         { en: 'The anvil will take these later. Inspect is open. Crafting is not.', es: 'El yunque las tomara mas tarde. Inspeccionar esta abierto. Forjar no.' },
