...
export class TranslationService {
  ...
  private translations: Translations = {
    ...
    'work.tile.xpForaging': { en: 'Foraging Level {{level}} · {{xp}} / {{next}} XP', es: 'Recoleccion nivel {{level}} · {{xp}} / {{next}} XP' },
    'work.tile.xpMaxForaging': { en: 'Foraging Level {{level}} · {{xp}} XP', es: 'Recoleccion nivel {{level}} · {{xp}} XP' },
    'work.tile.readyForaging': { en: 'Ready to gather at the Rootglass Canopy.', es: 'Listo para recolectar en el Rootglass Canopy.' },
    ...
    'hub.skills.tag': { en: 'Mining and Foraging are live. Other disciplines wait.', es: 'La mineria y la recoleccion estan activas. Las otras disciplinas esperan.' },
