...
export class TranslationService {
  ...
  private translations: Translations = {
    ...
    'gfnav.exchange':     { en: 'Exchange',      es: 'Lonja' },
    'gfnav.gambler':      { en: 'Gambler',       es: 'Apostador' },
    ...
    'forge.benchLink':    { en: 'The runes are struck here. Kit is forged at the bench \u2192', es: 'Las runas se golpean aqui. El equipo se forja en el banco \u2192' },
    'forge.tableLink':    { en: 'Runes go in sockets too. The Table is through here \u2192', es: 'Las runas tambien van en engarces. La Mesa esta por aqui \u2192' },
    'gfnav.crafting':     { en: 'Bench',         es: 'Banco' },
    'gfnav.hint.crafting': { en: 'Turn materials into kit', es: 'Convierte materiales en equipo' },
    'gfnav.coliseum':     { en: 'Coliseum',       es: 'Coliseo' },
    'gfnav.hint.coliseum': { en: 'Five rings, twenty-five challengers', es: 'Cinco anillos, veinticinco retadores' },
    'gfnav.leaderboards': { en: 'Standings',      es: 'Clasificaciones' },
    'gfnav.hint.leaderboards': { en: 'Seven ladders, your place on each', es: 'Siete escalas, tu lugar en cada una' },

    // ── The Coliseum ───────────────────────────────────────
    // Opponent names, taunts and ring flavour are deliberately absent: they are
    // proper nouns and authored voice in the lore, and are rendered untranslated
    // in both languages exactly as realm names already are.
    'arena.eyebrow':      { en: '\u25cf THE COLISEUM',   es: '\u25cf EL COLISEO' },
    'arena.title':        { en: 'The Coliseum',   es: 'El Coliseo' },
    'arena.tagline':      { en: 'five rings, and a result read off the kit you walked in wearing', es: 'cinco anillos, y un resultado leido del equipo con el que entraste' },
    'arena.stat.points':  { en: 'Arena points',   es: 'Puntos de arena' },
    'arena.stat.record':  { en: 'Record',         es: 'Historial' },
    'arena.stat.streak':  { en: 'Streak',         es: 'Racha' },
    'arena.stat.rank':    { en: 'Standing',       es: 'Rango' },
    'arena.loadout.title':{ en: 'What you bring', es: 'Lo que traes' },
    'arena.loadout.might':{ en: 'Might',          es: 'Poder' },
    'arena.loadout.guard':{ en: 'Guard',          es: 'Guardia' },
    'arena.loadout.mightNote': { en: 'what you swing', es: 'lo que descargas' },
    'arena.loadout.guardNote': { en: 'what you subtract from what is swung at you', es: 'lo que restas de lo que te descargan' },
    'arena.loadout.rank': { en: 'Rank',           es: 'Nivel' },
    'arena.loadout.strike': { en: 'Strike (worn)', es: 'Golpe (equipado)' },
    'arena.loadout.ward': { en: 'Ward (worn)',    es: 'Proteccion (equipada)' },
    'arena.loadout.forge': { en: 'Forge Power',   es: 'Poder de forja' },
    'arena.loadout.hint': { en: 'Both numbers are read off worn kit and allocated stats, live.', es: 'Ambos numeros se leen del equipo puesto y los puntos asignados, en vivo.' },
    'arena.loadout.link': { en: 'Change your kit \u2192', es: 'Cambia tu equipo \u2192' },
    'arena.lock.ready':   { en: 'The gate is open.', es: 'La puerta esta abierta.' },
    'arena.lock.waiting': { en: 'Catching your breath \u2014', es: 'Recuperando el aliento \u2014' },
    'arena.rings.title':  { en: 'The five rings', es: 'Los cinco anillos' },
    'arena.rings.won':    { en: 'won',            es: 'ganados' },
    'arena.rings.gold':   { en: 'Gold',           es: 'Oro' },
    'arena.rings.xp':     { en: 'XP',             es: 'XP' },
    'arena.rings.points': { en: 'Points',         es: 'Puntos' },
    'arena.rings.oddsNote': { en: 'against this ring\u2019s easiest name \u2014 each challenger below carries its own', es: 'contra el nombre mas facil de este anillo; cada retador de abajo lleva el suyo' },
    'arena.rings.challenge': { en: 'Challenge',      es: 'Retar a' },
    'arena.rings.locked': { en: 'Chained. Win',   es: 'Encadenado. Gana' },
    'arena.rings.lockedTail': { en: 'more in the ring below.', es: 'mas en el anillo anterior.' },
    'arena.rings.roster': { en: 'Who fights here', es: 'Quien pelea aqui' },
    'arena.rings.enter':  { en: 'Enter the ring', es: 'Entra al anillo' },
    'arena.rings.chained':{ en: 'Chained',        es: 'Encadenado' },
    'arena.shop.title':   { en: 'The quartermaster', es: 'El intendente' },
    'arena.shop.blurb':   { en: 'Arena points buy things the rest of the world already understands \u2014 kit, Gold, Essence, materials.', es: 'Los puntos de arena compran cosas que el resto del mundo ya entiende: equipo, oro, esencia, materiales.' },
    'arena.shop.needs':   { en: 'Needs',          es: 'Requiere' },
    'arena.shop.wins':    { en: 'wins',           es: 'victorias' },
    'arena.shop.pts':     { en: 'pts',            es: 'pts' },
    'arena.shop.buy':     { en: 'Take it',        es: 'Tomalo' },
    'arena.shop.owned':   { en: 'Taken',          es: 'Tomado' },
    'arena.fight.label':  { en: 'Bout result',    es: 'Resultado del combate' },
    'arena.fight.close':  { en: 'Close the bout', es: 'Cerrar el combate' },
    'arena.fight.you':    { en: 'You',            es: 'Tu' },
    'arena.fight.guard':  { en: 'Guard',          es: 'Guardia' },
    'arena.fight.roundWon':  { en: 'yours',       es: 'tuyo' },
    'arena.fight.roundLost': { en: 'theirs',      es: 'suyo' },
    'arena.fight.victory':{ en: 'Victory',        es: 'Victoria' },
    'arena.fight.defeat': { en: 'Defeat',         es: 'Derrota' },
    'arena.fight.streak': { en: 'Streak bonus',   es: 'Bono de racha' },
    'arena.fight.consolation': { en: 'Nothing taken. The house pays you anyway:', es: 'No perdiste nada. La casa te paga igualmente:' },
    'arena.fight.unlocked': { en: 'A new gate is unchained:', es: 'Una nueva puerta se desencadena:' },
    'arena.fight.done':   { en: 'Leave the sand', es: 'Deja la arena' },

    // ── The Standings ───────────────────────────────────
    // Board names and blurbs live in LEADERBOARD_CATEGORIES, alongside their
    // summits and curves; splitting the copy from the number it describes would
    // have put a board's honesty in two files.
    'leaderboards.eyebrow': { en: '\u25cf THE STANDINGS', es: '\u25cf LAS CLASIFICACIONES' },
    'leaderboards.title': { en: 'The Standings',  es: 'Las Clasificaciones' },
    'leaderboards.tagline': { en: 'seven ladders, and your own place on each one marked in gold', es: 'siete escalas, y tu lugar en cada una marcado en oro' },
    'leaderboards.honesty': { en: 'The other names on these ladders are a generated field, not other players \u2014 the world keeps no public table of anyone\u2019s save. What is real is your own number, and how far it still is to the next rung.', es: 'Los demas nombres de estas escalas son un campo generado, no otros jugadores: el mundo no guarda ninguna tabla publica de la partida de nadie. Lo real es tu propio numero, y cuanto falta para el siguiente escalon.' },
    'leaderboards.tabsLabel': { en: 'Choose a ladder', es: 'Elige una escala' },
    'leaderboards.yourRank': { en: 'Your rank',   es: 'Tu puesto' },
    'leaderboards.toNext':{ en: 'Still',          es: 'Aun faltan' },
    'leaderboards.behind':{ en: 'behind',         es: 'para alcanzar a' },
    'leaderboards.first': { en: 'Nobody on this ladder is ahead of you.', es: 'Nadie en esta escala esta por delante de ti.' },
    'leaderboards.col.rank': { en: 'Rank',        es: 'Puesto' },
    'leaderboards.col.name': { en: 'Name',        es: 'Nombre' },
    'leaderboards.doorsLabel': { en: 'Where to climb', es: 'Donde escalar' },
    'leaderboards.door.arena': { en: 'Fight in the Coliseum \u2192', es: 'Pelea en el Coliseo \u2192' },
    'leaderboards.door.character': { en: 'Your character \u2192', es: 'Tu personaje \u2192' },
    'leaderboards.door.codex': { en: 'The Codex \u2192', es: 'El Codice \u2192' },

    'gfnav.enchanting':   { en: 'Table',         es: 'Mesa' },
    'gfnav.hint.enchanting': { en: 'Set runes, burn materials', es: 'Engarza runas, quema materiales' },

    // ── The Enchanting Table ──────────────────────────────────────────────
    'enchant.eyebrow':    { en: '\u25cf THE ENCHANTING TABLE', es: '\u25cf LA MESA DE ENCANTAMIENTO' },
    'enchant.title':      { en: 'The Table',      es: 'La Mesa' },
    'enchant.tagline':    { en: 'runes into wells, materials into the burner \u2014 what your gear is spelling, and for how long', es: 'runas en los huecos, materiales al fuego \u2014 lo que tu equipo deletrea, y por cuanto tiempo' },
    'enchant.stat.gold':  { en: 'Gold',           es: 'Oro' },
    'enchant.stat.words': { en: 'Socket Words',   es: 'Palabras de engarce' },
    'enchant.stat.running': { en: 'Infusions',    es: 'Infusiones' },
    'enchant.dismiss':    { en: 'Dismiss',        es: 'Descartar' },

    'enchant.sockets.title':   { en: 'Sockets',   es: 'Engarces' },
    'enchant.sockets.hint':    { en: 'Weapons hold up to three wells, armour up to two. A rune set into a well pays while the piece is worn, and comes back out for Gold.', es: 'Las armas tienen hasta tres huecos, las armaduras hasta dos. Una runa engarzada rinde mientras llevas la pieza, y sale de nuevo por Oro.' },
    'enchant.sockets.empty':   { en: 'Nothing you own will hold a rune yet. Craft or find a weapon or a piece of armour and it arrives with its wells already cut.', es: 'Nada de lo que tienes admite runas todavia. Forja o encuentra un arma o una armadura y llegara con sus huecos ya tallados.' },
    'enchant.sockets.pick':    { en: 'Pieces that hold runes', es: 'Piezas que admiten runas' },
    'enchant.sockets.wells':   { en: 'Wells',     es: 'Huecos' },
    'enchant.sockets.well':    { en: 'Well',      es: 'Hueco' },
    'enchant.sockets.emptyWell': { en: 'Empty well', es: 'Hueco vacio' },
    'enchant.sockets.pull':    { en: 'Pull',      es: 'Extraer' },
    'enchant.sockets.drawer':  { en: 'The rune drawer', es: 'El cajon de runas' },
    'enchant.sockets.drawerEmpty': { en: 'The drawer is empty. Strike the anvil at the Forge until something falls out of it.', es: 'El cajon esta vacio. Golpea el yunque en la Forja hasta que caiga algo.' },
    'enchant.sockets.close':   { en: 'Close',     es: 'Cerrar' },
    'enchant.sockets.base':    { en: 'Base roll', es: 'Tirada base' },
    'enchant.sockets.runes':   { en: 'From runes', es: 'De las runas' },
    'enchant.sockets.total':   { en: 'What it pays', es: 'Lo que rinde' },
    'enchant.sockets.none':    { en: '\u2014',   es: '\u2014' },
    'enchant.sockets.seated':  { en: 'Seated word', es: 'Palabra asentada' },
    'enchant.sockets.weapon':  { en: 'Weapon',    es: 'Arma' },
    'enchant.sockets.armor':   { en: 'Armour',    es: 'Armadura' },
    'enchant.sockets.worn':    { en: 'Worn',      es: 'Equipada' },

    'enchant.words.title':     { en: 'Socket Words', es: 'Palabras de engarce' },
    'enchant.words.tagline':   { en: 'Fifteen sequences nobody wrote down. Fill every well on a piece with the right runes in the right order and the piece starts paying something the runes alone do not.', es: 'Quince secuencias que nadie escribio. Llena cada hueco de una pieza con las runas correctas en el orden correcto y la pieza rendira algo que las runas solas no dan.' },
    'enchant.words.clue':      { en: 'Clue',      es: 'Pista' },
    'enchant.words.discovered': { en: 'A word has seated', es: 'Una palabra se ha asentado' },
    'enchant.words.frame.weapon': { en: 'Weapon only', es: 'Solo armas' },
    'enchant.words.frame.armor':  { en: 'Armour only', es: 'Solo armaduras' },
    'enchant.words.frame.any':    { en: 'Any piece',   es: 'Cualquier pieza' },

    'enchant.infusion.title':   { en: 'Infusions', es: 'Infusiones' },
    'enchant.infusion.tagline': { en: 'Burn what the gathering skills bring home for an hour or two of something better. Three at once, no more, and they do not extend \u2014 let one lapse and brew it again.', es: 'Quema lo que traen las habilidades de recoleccion a cambio de una o dos horas de algo mejor. Tres a la vez, no mas, y no se prolongan: deja que una caduque y vuelve a prepararla.' },
    'enchant.infusion.brew':    { en: 'Light the burner', es: 'Encender el fuego' },
    'enchant.infusion.running': { en: 'Running',   es: 'En marcha' },
    'enchant.infusion.short':   { en: 'Short of materials', es: 'Faltan materiales' },
    'enchant.infusion.full':    { en: 'All three slots are full', es: 'Los tres huecos estan llenos' },
    'enchant.infusion.slots':   { en: 'Slots in use', es: 'Huecos en uso' },
    'enchant.infusion.left':    { en: 'Left:',     es: 'Queda:' },

    // ── The Crafting Bench ────────────────────────────────────────────────
    'crafting.eyebrow':   { en: '\u25cf THE CRAFTING BENCH', es: '\u25cf EL BANCO DE FORJA' },
    'crafting.title':     { en: 'The Bench',      es: 'El Banco' },
    'crafting.tagline':   { en: 'what the seams and the canopy gave up, struck into something you can wear', es: 'lo que las vetas y el dosel entregaron, forjado en algo que puedes vestir' },
    'crafting.level':     { en: 'Level',          es: 'Nivel' },
    'crafting.lvl':       { en: 'Lvl',            es: 'Nvl' },
    'crafting.stat.xp':   { en: 'Crafting XP',    es: 'XP de forja' },
    'crafting.stat.known':{ en: 'Recipes known',  es: 'Recetas conocidas' },
    'crafting.stat.mastered': { en: 'Mastered',   es: 'Dominadas' },
    'crafting.stat.gold': { en: 'Gold',           es: 'Oro' },
    'crafting.filters':   { en: 'Recipe filters', es: 'Filtros de recetas' },
    'crafting.search':    { en: 'Search recipes and materials', es: 'Buscar recetas y materiales' },
    'crafting.all':       { en: 'All',            es: 'Todo' },
    'crafting.recipes':   { en: 'recipes',        es: 'recetas' },
    'crafting.empty':     { en: 'Nothing on the bench matches that.', es: 'Nada en el banco coincide con eso.' },
    'crafting.filter.realm':       { en: 'Realm',       es: 'Reino' },
    'crafting.filter.allRealms':   { en: 'All realms',  es: 'Todos los reinos' },
    'crafting.filter.unaligned':   { en: 'Unaligned',   es: 'Sin reino' },
    'crafting.filter.rarity':      { en: 'Rarity',      es: 'Rareza' },
    'crafting.filter.allRarities': { en: 'All rarities', es: 'Todas las rarezas' },
    'crafting.filter.status':      { en: 'Status',      es: 'Estado' },
    'crafting.filter.everything':  { en: 'Everything',  es: 'Todas' },
    'crafting.filter.ready':       { en: 'Ready to craft', es: 'Listas para forjar' },
    'crafting.filter.known':       { en: 'Already known',  es: 'Ya conocidas' },
    'crafting.slots':     { en: 'On the anvil',   es: 'En el yunque' },
    'crafting.load':      { en: 'Load',           es: 'Cargar' },
    'crafting.take':      { en: 'Take off',       es: 'Retirar' },
    'crafting.loadAll':   { en: 'Load the anvil', es: 'Cargar el yunque' },
    'crafting.clear':     { en: 'Clear',          es: 'Vaciar' },
    'crafting.dragHint':  { en: 'Drag a material onto its slot, or press Load.', es: 'Arrastra un material a su hueco, o pulsa Cargar.' },
    'crafting.loadFirst': { en: 'Load every slot before you strike.', es: 'Carga todos los huecos antes de golpear.' },
    'crafting.craft':     { en: 'Strike the anvil', es: 'Golpear el yunque' },
    'crafting.working':   { en: 'Working \u2014',  es: 'Trabajando \u2014' },
    'crafting.time':      { en: 'Time',           es: 'Tiempo' },
    'crafting.instant':   { en: 'Instant',        es: 'Al instante' },
    'crafting.xp':        { en: 'XP',             es: 'XP' },
    'crafting.upTo':      { en: 'up to',          es: 'hasta' },
    'crafting.rollNote':  { en: 'Every craft rolls its own numbers. Mastery raises the floor.', es: 'Cada forja tira sus propios numeros. El dominio sube el minimo.' },
    'crafting.mastered':  { en: 'Mastered',       es: 'Dominada' },
    'crafting.mastery.progress': { en: 'Toward mastery', es: 'Hacia el dominio' },
    'crafting.mastery.done':     { en: 'Mastered \u2014 every roll on this recipe is 10% better, forever.', es: 'Dominada: cada tirada de esta receta es un 10% mejor, para siempre.' },
    'crafting.result.done':      { en: 'Off the anvil', es: 'Sale del yunque' },
    'crafting.result.mastered':  { en: 'Mastered \u2014 off the anvil', es: 'Dominada: sale del yunque' },
    'crafting.result.note':      { en: 'It is in your bag. Equip it on Character, or list it on the Exchange.', es: 'Esta en tu bolsa. Equipalo en Personaje, o listalo en la Lonja.' },
    'crafting.dismiss':   { en: 'Dismiss',        es: 'Cerrar' },
    ...
    'gfnav.hint.exchange':  { en: 'Trade at the merchant houses',   es: 'Comercia en las casas mercantes' },
    'gfnav.hint.gambler':   { en: 'Sealed boxes, odds published',    es: 'Cajas selladas, probabilidades publicadas' },
    ...
    'footer.paypal.note': { en: 'Every drop of fuel keeps the forge burning and the realms growing.', es: 'Cada gota de combustible mantiene la forja ardiendo y los reinos creciendo.' },
    ...
    'onboarding.welcome.body':  { en: 'A free idle RPG in your browser. Strike the forge for Gold, gamble it on runes, craft gear with rolled stats, and send explorers into five realms. No sign-up, no install.',
                                  es: 'Un RPG idle gratis en tu navegador. Golpea la forja por Oro, apuestalo en runas, fabrica equipo con estadisticas variables y envia exploradores a cinco reinos. Sin registro, sin instalar.' },
    ...
    'onboarding.strike.after':  { en: 'Yours, and already banked. The flame sits in the corner of every page — strike it any time, anywhere on the site.',
                                  es: 'Tuyo, y ya guardado. La llama esta en la esquina de cada pagina — golpeala cuando quieras, donde quieras.' },
    ...
    'onboarding.doors.title':   { en: 'What you do here', es: 'Que se hace aqui' },
    'onboarding.doors.body':    { en: 'Start at the top — it is free and it pays for the rest.',
                                  es: 'Empieza arriba — es gratis y paga todo lo demas.' },
    'onboarding.doors.enter':   { en: 'Go',               es: 'Ir' },
    'onboarding.doors.first':   { en: 'Do this first',    es: 'Haz esto primero' },
    'onboarding.doors.cta':     { en: 'One more thing',   es: 'Una cosa mas' },

    'onboarding.door.scout.title':  { en: 'Send a Scout',
                                      es: 'Envia un explorador' },
    'onboarding.door.scout.body':   { en: 'You already have two explorers. A Scout is free, takes two minutes, and comes back with 5,000-10,000 Gold.',
                                      es: 'Ya tienes dos exploradores. Un reconocimiento es gratis, dura dos minutos y vuelve con 5.000-10.000 de Oro.' },
    'onboarding.door.runes.title':  { en: 'The Rune Forge',
                                      es: 'La Forja de Runas' },
    'onboarding.door.runes.body':   { en: '10,000 Gold a strike. Twenty-five runes across seven tiers, and a Void rune at one in two million.',
                                      es: '10.000 de Oro por golpe. Veinticinco runas en siete niveles, y una runa del Vacio a una entre dos millones.' },
    'onboarding.door.bench.title':  { en: 'The Bench',
                                      es: 'El Banco' },
    'onboarding.door.bench.body':   { en: 'Fifty-two recipes. Mine and forage the realms, then strike the materials into gear with rolled stats.',
                                      es: 'Cincuenta y dos recetas. Mina y recolecta en los reinos, y forja los materiales en equipo con estadisticas variables.' },
    'onboarding.door.market.title': { en: 'The Market',
                                      es: 'El Mercado' },
    'onboarding.door.market.body':  { en: 'Upgrades from 5,000 Gold that earn for you on their own, plus enchantments and permanent artifacts.',
                                      es: 'Mejoras desde 5.000 de Oro que ganan por si solas, mas encantamientos y artefactos permanentes.' },

    'onboarding.return.title':    { en: 'Come back tomorrow', es: 'Vuelve manana' },
    'onboarding.return.body':     { en: 'Three quests are drawn fresh every day, and a return streak pays more for each day you keep it — up to twelve days.',
                                    es: 'Tres misiones nuevas cada dia, y una racha de regreso paga mas por cada dia que la mantengas — hasta doce dias.' },
    ...
    // Names the genre in the first six words. The line before this one read
    // "A persistent world of five Eclipse Realms — wander, collect, and forge
    // your legend", which is the right sentence for somebody who already knows
    // what this is and tells a stranger from a link nothing: not that it is a
    // game, not that it is free, not that it needs no account. Lore is the
    // eyebrow above it; this line is the pitch.
    'godforge.hero.sub':       { en: 'A free idle RPG in your browser. Strike the forge, gamble runes, craft gear with rolled stats, and send explorers into five realms. No sign-up, no install.', es: 'Un RPG idle gratis en tu navegador. Golpea la forja, apuesta runas, fabrica equipo con estadisticas variables y envia exploradores a cinco reinos. Sin registro, sin instalar.' },
    ...
    'market.free':              { en: 'Free', es: 'Gratis' },
    'market.buy.free':          { en: 'Take {{name}} — free', es: 'Toma {{name}} — gratis' },
    'market.scout.title':       { en: 'Send a Scout first',
                                  es: 'Envia primero un Explorador' },
    'market.scout.body':        { en: 'Free, two minutes, and it comes back with 5,000-10,000 Gold. You already have the explorers.',
                                  es: 'Gratis, dos minutos, y vuelve con 5.000-10.000 de Oro. Ya tienes a los exploradores.' },
    ...
    'market.cat.thrall':        { en: 'Forge Thralls', es: 'Siervos de la Forja' },
    ...
    'market.catShort.thrall':   { en: 'Thralls', es: 'Siervos' },
    ...
    'market.thrall.lead':       { en: 'Assign them, equip them and watch the shift from', es: 'Asignalos, equipalos y observa el turno desde' },
    'market.thrall.link':       { en: 'the Inner Sanctum', es: 'el Santuario Interior' },
    'market.thrall.tally':      { en: '{{owned}} of {{max}} bound · {{working}} of {{slots}} at the anvil.', es: '{{owned}} de {{max}} vinculados · {{working}} de {{slots}} en el yunque.' },
