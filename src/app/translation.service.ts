...
export class TranslationService {
  ...
  private translations: Translations = {
    ...
    'seamworks.full': { en: 'The bag cannot take another Cinder Ore. Clear a row first. No XP or discovery is rolled while the bag is full.', es: 'La bolsa no admite otro Cinder Ore. Libera una fila primero. No se tira XP ni descubrimiento con la bolsa llena.' },
    ...
    'seamworks.result.ore': { en: 'Bag: +1 Cinder Ore.', es: 'Bolsa: +1 Cinder Ore.' },
    ...
    'hub.loadout.title': { en: 'Loadout', es: 'Equipo' },
    'hub.loadout.tag': { en: 'Wear and remove gear here. Materials and runes live in the Bank.', es: 'Equipa y quita aqui. Materiales y runas viven en el Banco.' },
    'hub.loadout.wear': { en: 'Unequipped pieces', es: 'Piezas sin equipar' },
    'hub.loadout.empty': { en: 'Nothing to wear. Mine and craft land in the Bank.', es: 'Nada que vestir. Lo minado y forjado llega al Banco.' },
    ...
    'hub.skills.later.exploration': { en: 'Exploration — reserved', es: 'Exploracion — reservada' },
    'hub.skills.later.forge': { en: 'Forge skill — reserved', es: 'Habilidad de forja — reservada' },
    'hub.skills.later.hunting': { en: 'Hunting — reserved', es: 'Caza — reservada' },
    ...
    'forge.eyebrow':            { en: 'The Forge', es: 'La Forja' },
    'forge.title':              { en: 'Strike the Anvil', es: 'Golpea el yunque' },
    'forge.tag':                { en: 'Runes, words, and the weapons that will follow. Codex keeps the record; this hall crafts.', es: 'Runas, palabras y las armas que vendran. El Codice guarda el registro; este salon forja.' },
